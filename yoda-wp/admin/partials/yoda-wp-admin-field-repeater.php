...
?><ul class="repeaters"><?php
    for ( $i = 0; $i <= $count; $i++ ) {
        ...
        ?><li class="<?php echo esc_attr( $setatts['class'] ); ?>">
            <div class="handle">
                <span class="title-repeater"><?php echo esc_html( $setatts['label-header'], 'yoda-wp' ); ?></span>
                <button aria-expanded="true" class="btn-edit" type="button">
                    <span class="screen-reader-text"><?php echo esc_html( $setatts['label-edit'], 'yoda-wp' ); ?></span>
            ...
            <div class="repeater-content">
                ...
                <div>
                    <a class="link-remove" href="#">
                        <span><?php
                            echo esc_html( apply_filters( $this->plugin_name . '-repeater-remove-link-label', $setatts['label-remove'] ), 'yoda-wp' );
                        ?></span>
                    </a>
                </div>
            </div>
    ...
    ?><div class="repeater-more">
        ...
        <a class="button" href="#" id="add-repeater"><?php
            echo esc_html( apply_filters( $this->plugin_name . '-repeater-more-link-label', $setatts['label-add'] ), 'yoda-wp' );
        ?></a>
    </div><!-- .repeater-more -->
</ul><!-- repeater -->
